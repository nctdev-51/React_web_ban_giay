  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex bg-[#f9fafb] font-sans text-[#111]">
      ...
      <aside className="w-64 bg-black text-white flex flex-col h-full flex-shrink-0 shadow-2xl z-20">
        <div className="p-8">
          <h2 className="text-2xl font-black tracking-tighter italic text-white leading-none">TQS ADMIN</h2>
          <div className="mt-2 flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
            <span className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Hệ thống đang chạy</span>
          </div>
        </div>
        ...
        <header className="h-[80px] bg-white/80 backdrop-blur-md border-b border-gray-200 px-8 flex justify-between items-center flex-shrink-0 z-10">
          ...
          <div className="flex items-center gap-6">
            <div className="text-right hidden sm:block">
              ...
              <p className="text-[11px] text-gray-500 font-medium">Quản trị viên hệ thống</p>
            </div>
