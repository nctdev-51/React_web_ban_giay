...
export default function GuestCheckout() {
  ...
  /**
   * useCallback:
   * Ghi nhớ hàm submit để tránh tạo mới sau mỗi lần render
   *
   * Hiện tại đang giả lập gửi dữ liệu lên server.
   * Sau này có thể thay bằng axios.post / fetch tới json-server hoặc backend thật.
   */
  const handleSubmit = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      /**
       * TODO:
       * Sau này thay bằng gọi API thật, ví dụ:
      ...
      /**
       * Sau khi đặt hàng thành công thì xóa giỏ hàng trong Redux
       */
      dispatch(clearCart());
    },
    [dispatch],
