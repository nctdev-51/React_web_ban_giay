...
// Định nghĩa Type an toàn cho DB
          ...
          >
            ...
            <section className="border-t border-gray-200 pt-8">
              ...
              <div className="space-y-3 mb-6">
                {/* Giữ nguyên các nút thanh toán của bạn */}
                <button
                  type="button"
                  onClick={() =>
                    setFormData((p) => ({ ...p, paymentMethod: "card" }))
                  }
                  className={`w-full h-14 rounded-lg border px-4 flex items-center justify-between text-sm transition-colors ${formData.paymentMethod === "card" ? "border-black bg-gray-50 ring-1 ring-black" : "border-gray-300 bg-white hover:border-gray-400"}`}
                >
