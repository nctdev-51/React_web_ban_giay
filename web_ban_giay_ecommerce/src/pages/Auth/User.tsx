...
const User: React.FC = () => {
    ...
    const avatarLabel = `${user.firstName?.charAt(0) || ""}${user.surname?.charAt(0) || ""}`.toUpperCase();

    let joinedDate = "Any Day"; // Giá trị dự phòng
        ...
        <div className="max-w-7xl mx-auto px-6 py-10 font-sans text-neutral-900 min-h-[70vh]">
            ...
            <main className="flex flex-wrap justify-between items-center pb-10 mb-10 border-b border-gray-200 gap-5">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        <h1 className="text-3xl font-medium mb-2">{user.firstName} {user.surname}</h1>
                        <p className="text-base text-gray-500 m-0">Nike Member Since {joinedDate}</p>
                    </div>
                </div>
            </main>
